...
function Login() {
    ...
    return (
        <div className=' md:mr-16 md:top-20 absolute w-[70%] h-64 top-56 md:right-0   md:w-[30%]   md:rounded-2xl   md:block z-50'>
            <div className='flex flex-col justify-around  h-56 md:h-96 2xl:h-56  md:py-20 w-[100%] '>
                ...
                <div className='flex flex-col md:items-center md:mt-5 mt-7'>
                    <button className='bg-[#07dd47] border rounded-full text-white px-10 md:py-2 py-1 shadow-ms hover:shadow-xl active:scale-90 transition duration-150 md:w-56 ' onClick={(e)=>signInUser(e)}>Sigin</button>
                    <div className='flex justify-between mt-1 '>
                        <button className="md:pr-16 text-gray-200   underline-offset-1 font-semibold">Recover password!</button>
                        <button className='text-gray-200    font-semibold ' onClick={registerHandler}>Signup!</button>
                    </div>
                </div>
