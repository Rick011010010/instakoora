  ...
  return (
    <div className=" hidden md:absolute md:w-[60%] xl:w-[40%] md:px-10 md:top-80 xl:top-96 md:flex md:flex-col md:justify-around md:h-60 md:py-9'">
      ...
      <div className="abdolute xl:mt-10">
        <h1 className=" lg:text-4xl md:text-2xl  font-Merriweather my- tracking-wide xl:py-7 md:py-3 2xl:py-10 md:text-[#17D647] lg:text-white">Are you ready to take your football experience to another level.</h1>
        <p className=" tracking-wide text-xl font-opensans md:text-white lg:text-[#17D647] ">join Us and you would be able to create your own team and challenge the other teams near to you, By creating an accound you would be able to send or receiving requests from other players or teams to join them base on your location and the schedule that you made.</p>
