...
function About() {
  return (
    <div className=" hidden md:absolute md:w-[40%] md:px-10 md:top-72 md:flex md:flex-col md:justify-around md:h-60 md:py-10'">
      ...
      <div className="flex justify-center mt-6 text-bold  py-4"><button className='bg-[#6997C6] border-2 rounded-full text-white px-10 md:py-2 py-1 shadow-ms hover:shadow-xl active:scale-90 transition duration-150 md:w-60 border-white '>Signup!</button></div>
    </div>
  )
}
