...
function About() {
  ...
  return (
    <div className=" hidden md:absolute md:w-[60%] xl:w-[40%] md:px-10 md:top-80 xl:top-96 md:flex md:flex-col md:justify-around md:h-60 md:py-9'">
      <h1 className="md:text-[#17D647] lg:text-white 2xl:text-8xl lg:text-4xl md:text-3xl xl:text-6xl ">WELCOME TOoo <p className="md:text-white lg:text-[#17D647] ">INSTAkOORA</p> </h1>
